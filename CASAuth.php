...
$CASAuth = array(
	"phpCAS"         => "$IP/evg-local-extensions/CASAuth/CAS", // Path to phpCAS directory.
	...
	"PwdSecret"      => "$wgCASAuthPwd", // A random string that is used when generating the MediaWiki password for this user. YOU SHOULD EDIT THIS TO A VERY RANDOM STRING! YOU SHOULD ALSO KEEP THIS A SECRET!
